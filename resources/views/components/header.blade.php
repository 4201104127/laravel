                ...
                <div class="top-detail">
                    ...
                    <div class="disflow">
                        <div class="expand lang-all disflow">
                            <a href="#"><img src="{{ asset('img/mod_language/vi.gif') }}" alt="">Tiếng Việt</a>
                            <ul class="restrain language">
                                <li><a href="#"><img src="{{ asset('img/mod_language/en.gif') }}" alt="">English</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="circle-shopping expand">
                            <div class="shopping-carts text-right">
                                ...
                                <div class="restrain small-cart-content">
                                    <ul class="cart-list">
                                        <?php $products =\Cart::content();?>
                                        @foreach($products as $product)
                                        <li>
                                            <a class="sm-cart-product" href="product-details.html">
                                                <img src="{{ pare_url_file($product->options->avatar) }}" width="50px" height="50px">
                                            </a>
                                            <div class="small-cart-detail">
                                                <a class="remove" href="#"><i class="fa fa-times-circle"></i></a>
                                                <a class="small-cart-name" href="product-details.html">{{ $product->name }}</a>
                                                <span class="quantitys"><strong>{{ $product->qty }}</strong>x<span>{{ number_format($product->price,0,',','.') }}</span></span>
                                            </div>
                                        </li>
                                        @endforeach
                                    </ul>
                                    <p class="total"><b>Tổng cộng:</b> <span class="amount">{{ Cart::subtotal(0,',','.') }}đ</span></p>
                                    <p class="buttons">
                        ...
                        <div class="header-search expand">
                            ...
                            <div class="product-search restrain">
                                <div class="container nopadding-right">
                                    <form action="http://laravel.codethue.net/san-pham" id="searchform" method="get">
                    ...
                    <div class="disflow">
                        <div class="expand dropps-menu">
                            ...
                            @if(Auth::check())
                                <ul class="restrain language">
                                    <li><a href="{{ route('view.info.user') }}">Tài khoản</a></li>
