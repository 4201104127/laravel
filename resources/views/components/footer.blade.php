            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="single-snap-footer">
                        ...
                        <div class="cakewalk-footer-content">
                            <p class="footer-des">Vị thế của bóng đá Anh đang trở lại mạnh mẽ. Sau 48 năm, Champions League gồm MU, Man City, Tottenham và Liverpool.</p>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-snap-footer">
                        ...
                        <div class="cakewalk-footer-content">
                            <ul>
                                <li><a href="{{ route('get.aboutUs') }}" target="_blank">Về chúng tôi</a></li>
