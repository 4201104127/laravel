...
Route::prefix('admin')->middleware('CheckLoginAdmin')->group(function() {
    ...
    Route::group(['prefix' => 'transaction'], function (){
        ...
        Route::get('/{action}{id}','AdminTransactionController@actionDelete')->name('admin.get.action.transaction');
        Route::get('/active/{id}','AdminTransactionController@action')->name('admin.get.active.transaction');
    });
